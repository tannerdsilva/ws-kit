...
public final actor Client:Sendable {
	...
	nonisolated public let textStream:AsyncStream<String> = AsyncStream<String>()
	/// the continuation that will be used to send binary data to the user.
	nonisolated public let binaryStream:AsyncStream<[UInt8]> = AsyncStream<[UInt8]>()
	/// the continuation that will be used to send latency data to the user (latency as measured by ping and pong messages)
	nonisolated public let latencyStream:AsyncStream<MeasuredLatency> = AsyncStream<MeasuredLatency>()
	/// the continuation that will be used to send connection stage data to the user.
	nonisolated public let stateStream:AsyncStream<State> = AsyncStream<State>()
