...
extension WebSocket {
	...
	internal static func createClientBootstrap(url:URL.Split, headers:HTTPHeaders = [:], configuration:Client.Configuration, on eventLoop:EventLoop) throws -> NIOClientTCPBootstrap {
